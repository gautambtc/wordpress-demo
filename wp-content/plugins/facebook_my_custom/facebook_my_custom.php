<?php
/*
Plugin Name: facebook-Custom-calls
Plugin URI:  https://developer.wordpress.org/plugins/Twitter-Custom-calls/
Description: Facebook integration using php sdk
Version:     20161013
Author:      Manoj
...
// register_deactivation_hook( __FILE__, array( 'student', 'plugin_deactivation' ) );
  ...
  add_action('admin_menu', 'content_menu_facebook');
  function content_menu_facebook() {
    if (function_exists('add_menu_page')) {
      add_menu_page(__('facebook', 'facebook'), __('facebook', 'facebook'), 'manage_database', 'facebook_my_custom/views/index.php', '', 'dashicons-archive');
    }

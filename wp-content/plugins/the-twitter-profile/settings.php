            	...
            	<form method="post" action="options.php">
                    ...
                    <table class="form-table">
                    	<tbody>
                            ...
                            $wpt_tp_buy_extension_set .= '<a href="http://wp-plugins.in/buy_recent_tweets_extension" target="_blank"><img src="'.plugins_url( '/images/buy_button.png', __FILE__ ).'"></a>';
                            $wpt_tp_buy_extension_set .= '<p class="description">Recent tweets will be working after buying the extension, <a href="http://wp-plugins.in/buy_recent_tweets_extension" target="_blank">Buy Extension</a> for $3.99 only.</p>';
                            $wpt_tp_buy_extension_set .= '</td>';
                            $wpt_tp_buy_extension_set .= '</tr>';

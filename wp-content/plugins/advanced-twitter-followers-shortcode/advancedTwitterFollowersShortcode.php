...
$data .= "</div>
	...
	if($author != "true"){
	$data .= "<div style='font-size: 9px; color: #808080; font-weight: normal; font-family: tahoma,verdana,arial,sans-serif; line-height: 1.28; text-align: right; direction: ltr;'><a href='http://www.novusglassredmond.com/' target='_blank' style='color: #808080;' title='Redmond Novus'>Auto Glass Redmond</a></div>";}
        }
 	return $data;
 }
